...
namespace Perlink.Oi.Juridico.Domain.SAP.DTO.ManutencaoCategoriaPagamento
{
    public class CategoriaPagamentoExtrategicoExportacaoDTO
    {
        ...
        public string VaidaDescricaoAtivo
        {
            get
            {
                if (string.IsNullOrEmpty(DescricaoEstrategico))
                {
                    return "";
                }
                else if (!string.IsNullOrEmpty(DescricaoEstrategico) && Ativo == true)
                {
                    return "Sim";
                }
                else
