...
{
    public class TrabalhistaFM : IQuerySaldoGarantiaFM
    {
        ...
        public string RetornaGroupBy()
        {
            return @"
                        group by 
                            ...
                            decode(jur.processo.ind_processo_ativo, 'S', 'Sim', 'Não'), 
                            decode( jur.processo.ind_prioritaria, 'S', 'Sim', 'Não' )
                    ";
        }
        ...
        public string RetornaSelect()
        {
            return @"
                        select distinct jur.processo.cod_processo IdProcesso,
                            ...
                            decode( jur.processo.ind_prioritaria, 'S', 'Sim', 'Não' ) Estrategico,
