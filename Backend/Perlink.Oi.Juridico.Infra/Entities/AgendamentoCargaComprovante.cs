...
{
    public sealed class AgendamentoCargaComprovante : Notifiable, IEntity, INotifiable
    {
        private AgendamentoCargaComprovante()
        {
        }

        public int Id { get; private set; }

        public string NomeArquivoComprovante { get; private set; }
        ...
        public string NomeArquivoBaseSap { get; private set; }
        ...
        public static AgendamentoCargaComprovante Criar(string usuarioSolicitanteId) {
            var agendamentoCargaComprovante = new AgendamentoCargaComprovante() {
                DataAgendamento = DateTime.Now,
                UsuarioSolicitanteId = usuarioSolicitanteId,
                StatusAgendamentoId = Enums.StatusAgendamento.AGENDADO.Id,
        ...
        public void AtualizarNomesArquivosDeCarga(string arquivoComprovante, string arquivoBaseSAP) {

            NomeArquivoComprovante = arquivoComprovante;
            NomeArquivoBaseSap = arquivoBaseSAP;
