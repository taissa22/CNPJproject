...
{
    public class FeriadosRepository : BaseCrudRepository<Feriados, long>, IFeriadosRepository {
        private readonly JuridicoContext dbContext;

        public FeriadosRepository(JuridicoContext dbContext, IAuthenticatedUser user) : base(dbContext, user) {
