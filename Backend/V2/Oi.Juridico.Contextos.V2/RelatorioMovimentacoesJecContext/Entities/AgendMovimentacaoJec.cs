...
{
    public partial class AgendMovimentacaoJec
    {
        ...
        public virtual FechamentoMovJec IdBaseMovFimNavigation { get; set; }
        public virtual FechamentoMovJec IdBaseMovIniNavigation { get; set; }
