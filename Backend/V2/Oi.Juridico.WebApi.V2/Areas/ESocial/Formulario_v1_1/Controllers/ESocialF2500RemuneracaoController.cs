            ...
            try
            {
                ...
                if (formulario is not null)
                {
                    if (contrato is not null)
                    {
                        ...
                        listaErros.AddRange(service.ValidaAlteracaoMudancaCategoria(requestDTO, contrato).ToList());
            ...
            try
            {
                ...
                if (formulario is not null)
                {
                    if (contrato is not null)
                    {
                        ...
                        var listaErros = listaErrosDTO.ToList();
                        listaErros.AddRange(service.ValidaInclusaoRemuneracao(requestDTO, contrato).ToList());
                        ...
                        if (formulario is not null)
                        {
                            if (contrato is not null)
                            {
                                ...
                                foreach (var linha in linhas)
                                {
                                    ...
                                    var listaErros = listaErrosDTO.ToList();
                                    listaErros.AddRange(service.ValidaInclusaoRemuneracao(linha, contrato).ToList());
