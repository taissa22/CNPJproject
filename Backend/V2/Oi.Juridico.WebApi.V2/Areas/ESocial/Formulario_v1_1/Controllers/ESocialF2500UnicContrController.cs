            ...
            try
            {
                ...
                if (formulario is not null)
                {
                    ...
                    {                        
                        ...
                        listaErros.AddRange(service.ValidaAlteracaoUnicidadeContratual(requestDTO, contrato).ToList());
            ...
            try
            {
                ...
                if (formulario is not null)
                {
                    ...
                    {                        
                        ...
                        var listaErros = listaErrosDTO.ToList();
                        listaErros.AddRange(service.ValidaInclusaoUnicidadeContratual(requestDTO, contrato).ToList());
