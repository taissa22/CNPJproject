...
namespace Oi.Juridico.WebApi.V2.Areas.ESocial.v1_1.Controllers
{
    ...
    public partial class ESocialF2500Controller : ControllerBase
    {
        ...
        [TemPermissao(Permissoes.ACESSAR_CADASTRO_ESOCIAL)]
        public async Task<ActionResult> AlteraFormulario2500Async([FromRoute] int codigoFormulario, [FromRoute] byte statusFormulario, [FromBody] EsF2500RequestDTO requestDTO, [FromServices] ESocialF2500Service service, CancellationToken ct)
        {
            try
            {
