...
namespace Oi.Juridico.WebApi.V2.Areas.PautaJuizado.Controllers
{
    ...
    [ApiController]
    public class PautaCivelConsumidorComposicao : ControllerBase
    {
        ...
        public PautaCivelConsumidorComposicao(PautaJuizadoComposicaoContext pautaJuizadoComposicaoContext, ParametroJuridicoContext parametroJuridicoContext, EmailSender emailSender)
        {
        ...
        public IActionResult ListarPautaComposicaoAsync([FromBody] ListarPautaCivelConsumidorComposicao model, CancellationToken ct)
        {
            var lstPauta = ObterListaPautaComposicaoBase(model,ct);
        ...
        private List<ListarPautaCivelConsumidorComposicaoResponse> ObterListaPautaComposicaoBase(ListarPautaCivelConsumidorComposicao model, CancellationToken ct)
        {
            List<ListarPautaCivelConsumidorComposicaoResponse> lstPauta = new List<ListarPautaCivelConsumidorComposicaoResponse>();
        ...
        public IActionResult ListarPautaComposicaoAudienciaAsync([FromBody] ListarPautaCivelConsumidorComposicaoAudiencia model, CancellationToken ct)
        {
       ...
       [HttpPost("AlterarAlocacaoTodos")]
        public IActionResult AlterarTipoAlocacaoPaginaAsync([FromBody] ListarPautaCivelConsumidorComposicao model, CancellationToken ct)
        {
            ...
            try
            {
                ListarPautaCivelConsumidorComposicaoAudiencia filtro = new ListarPautaCivelConsumidorComposicaoAudiencia();
                List<ListarPautaCivelConsumidorComposicaoAudienciaResponse> lstAudiencia;
                string[] listaParte;

                foreach (ListarPautaCivelConsumidorComposicaoResponse itemPauta in lista)
                {   
                    ...
                    lstAudiencia = new List<ListarPautaCivelConsumidorComposicaoAudienciaResponse>();
                    ...
                    foreach (ListarPautaCivelConsumidorComposicaoAudienciaResponse item in lstAudiencia)
                    {
                        //  sql = "";
        ...
        public IActionResult PrepostosNaoAlocadosAsync([FromBody] ListarPautaCivelConsumidorComposicaoPreposto model, CancellationToken ct)
        {
        ...
        public IActionResult PrepostosAlocadosAsync([FromBody] ListarPautaCivelConsumidorComposicaoPreposto model, CancellationToken ct)
        {
        ...
        private List<ListarPautaCivelConsumidorComposicaoAudienciaResponse> ObterPedidosPorProcesso(List<ListarPautaCivelConsumidorComposicaoAudienciaResponse> lstAudiencia)
        {
