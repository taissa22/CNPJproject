...
namespace Oi.Juridico.WebApi.V2.Areas.PautaJuizado.Controllers
{
    ...
    [ApiController]
    public class PautaProconComposicao : ControllerBase
    {
        ...
        public PautaProconComposicao(PautaJuizadoComposicaoContext pautaJuizadoComposicaoContext, ParametroJuridicoContext parametroJuridicoContext, EmailSender emailSender)
        {
        ...
        public IActionResult ListarPautaComposicaoAsync([FromBody] ListarPautaProconComposicao model, CancellationToken ct)
        {
        ...
        public IActionResult ListarPautaComposicaoAudienciaAsync([FromBody] ListarPautaProconComposicaoAudiencia model, CancellationToken ct)
        {
            List<ListarPautaProconComposicaoAudienciaResponse> lstAudiencia = new List<ListarPautaProconComposicaoAudienciaResponse>();
        ...
        public IActionResult AlterarTipoAlocacaoPaginaAsync([FromBody] ListarPautaProconComposicao model, CancellationToken ct)
        {
            ...
            try
            {
                ListarPautaProconComposicaoAudiencia filtro = new ListarPautaProconComposicaoAudiencia();
                List<ListarPautaProconComposicaoAudienciaResponse> lstAudiencia;
                string[] listaParte;

                foreach (ListarPautaProconComposicaoResponse itemPauta in lista)
                {
                   ...
                   // filtro.CodStatusAudiencia = model.CodStatusAudiencia;
                    ...
                    lstAudiencia = new List<ListarPautaProconComposicaoAudienciaResponse>();
                    ...
                    foreach (ListarPautaProconComposicaoAudienciaResponse item in lstAudiencia)
                    {
                        //  sql = "";
        ...
        private List<ListarPautaProconComposicaoResponse> ObterListaPautaComposicaoBase(ListarPautaProconComposicao model, CancellationToken ct)
        {
            List<ListarPautaProconComposicaoResponse> lstPauta = new List<ListarPautaProconComposicaoResponse>();
        ...
        public IActionResult PrepostosNaoAlocadosAsync([FromBody] ListarPautaProconComposicaoPreposto model, CancellationToken ct)
        {
        ...
        public IActionResult PrepostosAlocadosAsync([FromBody] ListarPautaProconComposicaoPreposto model, CancellationToken ct)
        {
        ...
        private List<ListarPautaProconComposicaoAudienciaResponse> ObterPedidosPorProcesso(List<ListarPautaProconComposicaoAudienciaResponse> lstAudiencia)
        {
