...
{
    internal class GrupoPedidoService : IGrupoPedidoService
    {
        private IDatabaseContext DatabaseContext { get; }
        private ILogger<IGrupoPedidoService> Logger { get; }
        private IUsuarioAtualProvider UsuarioAtual { get; }

        public GrupoPedidoService(IDatabaseContext databaseContext, ILogger<IGrupoPedidoService> logger, IUsuarioAtualProvider usuarioAtual)
        {
        ...
        public CommandResult Criar(CriarGrupoPedidoCommand command)
        {
            string entityName = "Grupo Pedido";
        ...
        public CommandResult Atualizar(AtualizarGrupoPedidoCommand command)
        {
            string entityName = "Grupo Pedido";
        ...
        public CommandResult Remover(int id)
        {
            ...
            try
            {
                ...
                GrupoPedido GrupoPedido = DatabaseContext.GruposPedidos.FirstOrDefault(x => x.Id == id);

                Logger.LogInformation(Infra.Extensions.Logs.RemovendoEntidade(entityName, id));
                DatabaseContext.Remove(GrupoPedido);
