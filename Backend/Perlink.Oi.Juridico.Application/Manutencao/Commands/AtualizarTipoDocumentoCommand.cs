...
{
    public class AtualizarTipoDocumentoCommand : Validatable, IValidatable
    {
        public int Id { get; set; }
        public string Descricao { get; set; }
        public bool MarcadoCriacaoProcesso { get; set; }
        public bool Ativo { get; set; }
        public int CodTipoProcesso { get; set; }
        public int? CodTipoPrazo { get; set; }
        public bool IndRequerDatAudiencia { get; set; }
        public bool IndPrioritarioFila { get; set; }
        public bool IndDocumentoProtocolo { get; set; }
