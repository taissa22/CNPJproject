...
namespace Perlink.Oi.Juridico.Application.Manutencao.Commands {
    ...
    public class AtualizarProfissionalCommand : Validatable, IValidatable {
        ...
        public override void Validate() {
            ...
            if (!string.IsNullOrEmpty(TelefonesAdicionais) && TelefonesAdicionais?.Length > 4000) {
                AddNotification("TelefonesAdicionais", "O campo telefones adicionais permite no máximo 4000 caracteres");
            }

            if (!string.IsNullOrEmpty(NumeroOAB) && NumeroOAB?.Length > 7) {
                AddNotification("NumeroOAB", "O campo Registro OAB permite no máximo 7 caracteres");
            }
