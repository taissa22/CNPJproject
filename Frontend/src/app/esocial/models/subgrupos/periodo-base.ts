export class PeriodoBase {
    constructor(
        ...
        calctribVrrendirrf: number,
        calctribVrrendirrf13: number,
    ) {
        ...
        this.idEsF2501Calctrib = idEsF2501Calctrib,
            ...
            this.calctribVrrendirrf = calctribVrrendirrf,
            this.calctribVrrendirrf13 = calctribVrrendirrf13
    }
    ...
    static fromObj(item: any) {
        return new PeriodoBase(
            ...
            item.calctribVrrendirrf,
            item.calctribVrrendirrf13,
        );
    }
