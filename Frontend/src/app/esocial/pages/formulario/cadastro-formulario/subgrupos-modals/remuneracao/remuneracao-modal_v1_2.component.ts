...
@Component({
  selector: 'app-remuneracao-modal-v1-2',
  templateUrl: './remuneracao-modal_v1_2.component.html',
  styleUrls: ['./remuneracao-modal_v1_2.component.scss'],
  providers: [{ provide: LOCALE_ID, useValue: 'pt-BR' }
  ]
})
export class RemuneracaoModal_v1_2_Component implements AfterViewInit {
