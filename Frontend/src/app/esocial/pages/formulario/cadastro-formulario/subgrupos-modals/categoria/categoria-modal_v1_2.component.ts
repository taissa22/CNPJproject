...
@Component({
  selector: 'app-categoria-modal-v1-2',
  templateUrl: './categoria-modal_v1_2.component.html',
  styleUrls: ['./categoria-modal_v1_2.component.scss']
})
export class CategoriaModal_v1_2_Component implements OnInit {
