...
@Component({
  selector: 'app-carregar-bloco',
  templateUrl: './carregar-bloco.component.html',
  styleUrls: ['./carregar-bloco.component.scss']
})
export class CarregarBlocoComponent implements OnInit {
