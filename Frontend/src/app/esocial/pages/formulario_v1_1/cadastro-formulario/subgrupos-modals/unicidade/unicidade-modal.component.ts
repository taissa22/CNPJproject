...
@Component({
  selector: 'app-unicidade-modal',
  templateUrl: './unicidade-modal.component.html',
  styleUrls: ['./unicidade-modal.component.scss']
})
export class UnicidadeModalComponent implements AfterViewInit {
  titulo: string;
