...
@Component({
  selector: 'app-contribuicao-modal',
  templateUrl: './contribuicao-modal.component.html',
  styleUrls: ['./contribuicao-modal.component.scss']
})
export class ContribuicaoModalComponent implements AfterViewInit {
