...
@Component({
  selector: 'app-trabalhista-administrativo',
  templateUrl: './trabalhista-administrativo.component.html',
  styleUrls: ['./trabalhista-administrativo.component.scss']
})
export class TrabalhistaAdministrativoComponent implements OnInit {
  @Input() lista: ParametizacaoClosing[];
  tipoProcesso: number = 6;
  ...
  alterarLista() {
    ...
    this.parametizacaoNova.classificaoClosingClientCO = form.classificacaoClosingFibra;
