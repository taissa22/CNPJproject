...
@Component({
  selector: 'app-juizado-especial',
  templateUrl: './juizado-especial.component.html',
  styleUrls: ['./juizado-especial.component.scss']
})
export class JuizadoEspecialComponent implements OnInit {
  @Input() lista: ParametizacaoClosing[];
  tipoProcesso: number = 7;
