...
@Component({
  selector: 'app-trabalhista-judicial',
  templateUrl: './trabalhista-judicial.component.html',
  styleUrls: ['./trabalhista-judicial.component.scss']
})
export class TrabalhistaJudicialComponent implements OnInit {
  @Input() lista: ParametizacaoClosing[];
  tipoProcesso: number = 2;
