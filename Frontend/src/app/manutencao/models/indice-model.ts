export class Indice {
    private constructor(id: number, descricao: string, codigoTipoIndice : string, codigoValorIndice : string, acumulado : boolean,acumuladoAutomatico : boolean ) {
      this.id = id;
